...
from gator.config import Argparser
from gator.core import Aminator
...
def run():
    ...
    if args.env:
        ...
        os.environ["GATOR_ENVIRONMENT"] = args.env
...
def plugin_manager():
    ...
    parser = argparse.ArgumentParser(description='Gator plugin install utility')
