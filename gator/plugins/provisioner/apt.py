...
from gator.util.metrics import cmdsucceeds, cmdfails, timer, lapse
...
class AptProvisionerPlugin(BaseProvisionerPlugin):
    ...
    @cmdsucceeds("gator.provisioner.apt.provision_package.count")
    @cmdfails("gator.provisioner.apt.provision_package.error")
    @lapse("gator.provisioner.apt.provision_package.duration")
    ...
    @cmdsucceeds("gator.provisioner.apt.apt_get_update.count")
    @cmdfails("gator.provisioner.apt.apt_get_update.error")
    @timer("gator.provisioner.apt.apt_get_update.duration")
