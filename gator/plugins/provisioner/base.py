...
from gator.util import download_file
from gator.util.linux import Chroot, monitor_command
from gator.util.metrics import fails, lapse
...
class BaseProvisionerPlugin(BasePlugin):
    ...
    @fails("gator.provisioner.provision_scripts.error")
    @lapse("gator.provisioner.provision_scripts.duration")
